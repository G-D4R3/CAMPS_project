...
public class EditActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.timetable_activity_edit);
        init();
    }
    ...
    private void checkMode(){
        Intent i = getIntent();
        mode = i.getIntExtra("mode",TimetableFragment.REQUEST_ADD);

        if(mode == TimetableFragment.REQUEST_EDIT){
            loadScheduleData();
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.submit_btn:
                if(mode == TimetableFragment.REQUEST_ADD){
                    inputDataProcessing();
                    Intent i = new Intent();
                ...
                else if(mode == TimetableFragment.REQUEST_EDIT){
                    inputDataProcessing();
                    Intent i = new Intent();
                    ArrayList<Schedule> schedules = new ArrayList<Schedule>();
                    schedules.add(schedule);
