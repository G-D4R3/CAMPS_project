...
public class TimetableView extends LinearLayout {
    ...
    static class Builder {
        ...
        public com.example.forstudent.Timetable.TimetableView build() {
            com.example.forstudent.Timetable.TimetableView timetableView = new com.example.forstudent.Timetable.TimetableView(context);
