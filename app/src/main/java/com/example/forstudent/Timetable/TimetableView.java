...
public class TimetableView extends LinearLayout {
    ...
    private static final int DEFUALT_SIDE_HEADER_FONT_SIZE_DP = 13;
    ...
    private void getAttrs(AttributeSet attrs){
        ...
        int titlesId = a.getResourceId(R.styleable.Timetableview_header_title, R.array.header_title);
        headerTitle = a.getResources().getStringArray(titlesId);
        int colorsId = a.getResourceId(R.styleable.Timetableview_sticker_colors, R.array.timetable_color);
        ...
        headerHighlightColor = a.getColor(R.styleable.Timetableview_header_highlight_color, getResources().getColor(R.color.header_highlight_color));
        a.recycle();
    }
    ...
    private void init() {
        ...
        stickerBox = view.findViewById(R.id.stickerbox);
        tableHeader = view.findViewById(R.id.tableheader);
        tableBox = view.findViewById(R.id.tablebox);
        ...
        for (int i = 0; i < rowCount; i++) {
            ...
            for (int k = 0; k < columnCount; k++) {
                ...
                if (k == 0) {
                    ...
                    tv.setTextSize(TypedValue.COMPLEX_UNIT_DIP, DEFUALT_SIDE_HEADER_FONT_SIZE_DP);
                    ...
                    tv.setText("");
                    tv.setBackground(getResources().getDrawable(R.drawable.timetable_border));
    ...
    static class Builder {
        ...
        public Builder(Context context) {
            ...
            headerTitle = context.getResources().getStringArray(R.array.header_title);
            stickerColors = context.getResources().getStringArray(R.array.timetable_color);
            startTime = DEFAULT_START_TIME;
            headerHighlightColor = context.getResources().getColor(R.color.header_highlight_color);
